...
class AddressResourceIT {
    ...
    private static final String DEFAULT_VAT_NUMBER = "AAAAAAAAA";
    private static final String UPDATED_VAT_NUMBER = "BBBBBBBBB";
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getVatNumber()).isEqualTo(DEFAULT_VAT_NUMBER);
        assertThat(testAddress.getIsDefault()).isEqualTo(DEFAULT_IS_DEFAULT);
    }
    ...
    void putExistingAddress() throws Exception {
        ...
        assertThat(testAddress.getVatNumber()).isEqualTo(UPDATED_VAT_NUMBER);
        assertThat(testAddress.getIsDefault()).isEqualTo(UPDATED_IS_DEFAULT);
    }
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.streetAddress(UPDATED_STREET_ADDRESS).vatNumber(UPDATED_VAT_NUMBER).isDefault(UPDATED_IS_DEFAULT);
