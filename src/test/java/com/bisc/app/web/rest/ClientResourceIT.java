...
import com.bisc.app.repository.ClientRepository;
...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().phoneNumber(DEFAULT_PHONE_NUMBER);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().phoneNumber(UPDATED_PHONE_NUMBER);
        return client;
    }
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.phoneNumber(UPDATED_PHONE_NUMBER);
