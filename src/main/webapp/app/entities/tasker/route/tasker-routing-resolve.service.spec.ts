...
import taskerResolve from './tasker-routing-resolve.service';

describe('Tasker routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: TaskerService;
  let resultTasker: ITasker | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ITasker returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        taskerResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultTasker = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultTasker).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ITasker>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
