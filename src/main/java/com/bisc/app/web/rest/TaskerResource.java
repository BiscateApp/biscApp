...
public class TaskerResource {
    ...
    public ResponseEntity<Tasker> partialUpdateTasker(
        ...
        Optional<Tasker> result = taskerRepository
            ...
            .map(existingTasker -> {
                ...
                if (tasker.getTaskerType() != null) {
                    existingTasker.setTaskerType(tasker.getTaskerType());
                }
    ...
    public ResponseEntity<List<Tasker>> getAllTaskers(
        ...
        Page<Tasker> page;
        if (eagerload) {
            page = taskerRepository.findAllWithEagerRelationships(pageable);
        } else {
            page = taskerRepository.findAll(pageable);
        }
    ...
    public ResponseEntity<Tasker> getTasker(@PathVariable Long id) {
        ...
        Optional<Tasker> tasker = taskerRepository.findOneWithEagerRelationships(id);
